    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="#AdminViolationTable">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="mb-4" id="AdminDashboard" style="margin-bottom:100px; color: white;">blank</div>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Dashboard</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Violation Summary</li>
                        </ol>
                        <div class="row">
                        ...
                        <div id="AdminViolationTable" style="margin-bottom:60px;"></div>
                        <div>
                            <div class="container-fluid px-4">
                        <h1 class="mt-4">Dresscode Violation Records</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">APC student dresscode violations for the year 2025</li>
                        </ol>
