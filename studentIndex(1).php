...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">DCV-MS</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="studentIndex.html">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Student dresscode violation record</li>
                        </ol>
                        <h5 class="mt-4">ID: --</h5>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="StudentTable" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php include 'getStudentTable.php'; ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
